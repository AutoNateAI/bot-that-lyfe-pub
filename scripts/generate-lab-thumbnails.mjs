...
// Bot That Lyfe Lab thumbnail style — navy/gold/white brand (see public/styles.css
...
console.log(`Generating ${items.length} Bot That Lyfe Lab thumbnails with gpt-image-2 (concurrency ${CONCURRENCY})...`);

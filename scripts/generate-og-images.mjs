...
// Navy/gold/white Bot That Lyfe Lab brand (see public/styles.css :root tokens).
...
await composite({
  ...
  footer: "Bot That Lyfe Lab · AI, Coding & Technical Training",
...
await composite({
  ...
  footer: "Bot That Lyfe Lab · Architecture, AI Engineering, Consulting",
...
await composite({
  screenshotFile: screenshotFor(index++),
  eyebrow: "Events",
  title: "Where Bot That Lyfe Shows Up",
  footer: "Bot That Lyfe Lab · Agent Systems & Human Systems Events",
...
await composite({
  ...
  footer: "Bot That Lyfe Lab · 4 Free Digital Courses",
  outFile: path.join(outDir, "courses.jpg"),
});

await composite({
  screenshotFile: screenshotFor(index++),
  eyebrow: "Bot That Lyfe Community",
  title: "Free Courses & Discord Support",
  footer: "Bot That Lyfe Discord",
...
await composite({
  ...
  eyebrow: "About",
  title: "Nathan Baker — Bot That Lyfe",
  footer: "Bot That Lyfe · Technical Opportunity Intelligence Lab",
...
for (const tutorial of tutorials) {
  ...
  await composite({
    ...
    footer: `Bot That Lyfe Lab · ${pack?.title || "Free Digital Course"}`,
...
for (const pack of tutorialPacks) {
  await composite({
    ...
    title: pack.title,
    footer: "Bot That Lyfe Lab · Free Digital Course",

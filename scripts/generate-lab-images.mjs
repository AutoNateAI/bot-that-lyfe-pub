...
const images = [
  ...
  {
    file: "lab/organizations-hero.jpg",
    size: "1536x1024",
  ...
  {
    file: "lab/investigations-hero.jpg",
    size: "1536x1024",
...
// scripts/generate-lab-images.mjs regenerates just files whose path

...
export function renderRegions() {
  ...
  return pageShell({
    title: "Regions | Bot That Lyfe",
    active: "regions",
    body,
    canonicalPath: "/regions",
    ogImage: "/assets/og/regions.jpg",
    description: "U.S. agricultural regions Bot That Lyfe is profiling — production, capital, freight, and the organizations that connect them, with Southeast Missouri as the deepest profile so far.",
    ogTitle: "Regions | Bot That Lyfe",
    ogDescription: "Agricultural regions profiled by Bot That Lyfe's economic-intelligence research, with Southeast Missouri as the deepest profile so far.",
  });
}
...
export function renderRegionDetail(region) {
  ...
  return pageShell({
    title: `${region.name} | Bot That Lyfe`,
    active: "regions",
    body,
    ...
    structuredData: region.status === "watchlist" ? [] : [
      {
        ...
        "name": region.name,
        "description": region.tagline,
        "url": `https://botthatlyfe.com/research-and-case-studies/${region.slug}`,
      },
    ],
  });
}
...
export function renderOrganizations() {
  ...
  return pageShell({
    title: "Organizations | Bot That Lyfe",
    active: "organizations",
    body,
    canonicalPath: "/organizations",
    ogImage: "/assets/og/organizations.jpg",
    description: "Agricultural lenders, elevators, and cooperatives profiled by Bot That Lyfe with verified public figures and sources, starting with Farm Credit Southeast Missouri.",
    ogTitle: "Organizations | Bot That Lyfe",
    ...
    structuredData: org.status === "watchlist" ? [] : [
      {
        ...
        "name": org.name,
        "description": org.tagline,
        "url": `https://botthatlyfe.com/research-and-case-studies/${org.slug}`,
      },
    ],
  });
}
...
export function renderSystems() {
  ...
  return pageShell({
    title: "Systems | Bot That Lyfe",
    active: "systems",
    body,
    canonicalPath: "/systems",
    ogImage: "/assets/og/systems.jpg",
    description: "Agricultural system deep dives from Bot That Lyfe: how financing, freight & storage, and processing & market access actually work, step by step.",
    ogTitle: "Systems | Bot That Lyfe",
...
export function renderSystemDetail(system) {
  ...
  return pageShell({
    title: `${system.name} | Bot That Lyfe`,
    active: "systems",
    body,
...
export function renderInvestigations() {
  ...
  return pageShell({
    title: "Open Questions | Bot That Lyfe",
    active: "investigations",
    body,
    canonicalPath: "/investigations",
    ogImage: "/assets/og/investigations.jpg",
    description: "Open agricultural business questions Bot That Lyfe is investigating — what's known, what's missing, and who we still need to talk to.",
    ogTitle: "Open Questions | Bot That Lyfe",
    ogDescription: "Open, honestly-labeled agricultural business questions Bot That Lyfe is investigating.",
  });
}
...
export function renderInvestigationDetail(investigation) {
  ...
  return pageShell({
    title: `${investigation.name} | Bot That Lyfe`,
    active: "investigations",
    body,
...
export function renderLab() {
  ...
  return pageShell({
    title: "The Lab | Bot That Lyfe",
    active: "lab",
    body,
    canonicalPath: "/lab",
    ogImage: "/assets/ag-lab/lab-hero.jpg",
    description: "The general research instrumentation behind Bot That Lyfe's agricultural intelligence work — projects, experiments, open source, and an evidence-ranked reading list.",
    ogTitle: "The Lab | Bot That Lyfe",
    ogDescription: "Methodology and instruments: the projects, experiments, open source, and reading list behind Bot That Lyfe's research.",
  });
}
...
export function renderProjects() {
  ...
  return pageShell({
    title: "Projects | Bot That Lyfe Lab",
    active: "projects",
    body,
    canonicalPath: "/projects",
    ogImage: "/assets/scenes/scene-02.jpg",
    description: "Active multi-week research programs from Bot That Lyfe, Nathan Baker's independent AI, software, and human-systems research lab.",
    ogTitle: "Projects | Bot That Lyfe Lab",
    ogDescription: "What's currently forming at the Bot That Lyfe lab, and which experiments and sources are attached to each research program.",
  });
}
...
export function renderExperiments(page = 1) {
  ...
  return pageShell({
    title: current > 1 ? `Experiments — Page ${current} | Bot That Lyfe Lab` : "Experiments | Bot That Lyfe Lab",
    active: "experiments",
    body,
    canonicalPath: current > 1 ? `/experiments/page/${current}` : "/experiments",
    ogImage: "/assets/scenes/scene-05.jpg",
    description: "The Bot That Lyfe lab notebook: question, hypothesis, method, and result for every experiment Nathan Baker runs.",
    ogTitle: "Experiments | Bot That Lyfe Lab",
    ogDescription: "Proposed and running experiments from Bot That Lyfe's independent AI, software, and human-systems research lab.",
...
export function renderOpenSource(page = 1) {
  ...
  return pageShell({
    title: current > 1 ? `Open Source — Page ${current} | Bot That Lyfe Lab` : "Open Source | Bot That Lyfe Lab",
    active: "open-source",
    body,
    canonicalPath: current > 1 ? `/open-source/page/${current}` : "/open-source",
    ogImage: "/assets/scenes/scene-07.jpg",
    description: "Open-source repositories Bot That Lyfe is studying, building with, or contributing to — and why each one matters to the lab's current research.",
    ogTitle: "Open Source | Bot That Lyfe Lab",
    ogDescription: "The repositories currently informing Bot That Lyfe's active research projects.",
    robots: current > 1 ? "noindex,follow" : "index,follow",
  });
}
...
export function renderProjectDetail(project) {
  ...
  return pageShell({
    title: `${project.name} | Bot That Lyfe Lab`,
    active: "projects",
    body,
    ...
    structuredData: [
      {
        ...
        "name": project.name,
        "description": project.description,
        "url": `https://botthatlyfe.com/projects/${project.slug}`,
      },
    ],
  });
}
...
export function renderExperimentDetail(experiment) {
  ...
  return pageShell({
    title: `${experiment.name} | Bot That Lyfe Lab`,
    active: "experiments",
    body,
...
export function renderOpenSourceDetail(repo) {
  ...
  const body = `
    <main class="article-page">
      ...
      <article class="article-detail">
        ...
        ${relatedExperiments.length ? `<h2>Bot That Lyfe Experiments Using This</h2><div class="detail-related-grid">${relatedExperiments.map((e) => experimentCard(e)).join("")}</div>` : ""}
        ${project ? `<h2>Part of</h2><div class="detail-related-grid">${projectCard(project)}</div>` : ""}
      </article>
    </main>
  `;
  ...
  return pageShell({
    title: `${repo.name} | Bot That Lyfe Lab`,
    active: "open-source",
    body,
...
export function renderSourceDetail(source) {
  ...
  return pageShell({
    title: `${source.title} | Bot That Lyfe Lab`,
    active: "articles",
    body,
...
export function renderEventDetail(event) {
  ...
  return pageShell({
    title: `${event.name} | Bot That Lyfe Lab`,
    active: "events",
    body,
...
export function renderPrograms(data) {
  ...
  return pageShell({
    title: "AI & Coding Training Program | Bot That Lyfe Lab",
    active: "programs",
    body,
...
export function renderAbout() {
  const values = [
    ["Curiosity", "Ask sharper questions about how university funding, research, and hiring actually move, not just repeat what's already assumed."],
    ["Systems Thinking", "See the money, the labs, the people, the technology, and the job market as one connected graph — not isolated headlines."],
  ...
  const faqs = [
    ...
    ["How do you make sure this is accurate?", "Every fact on this site links to its public source — a grant record, a lab's own page, a company's careers page, a GitHub repo. Where I don't have real data yet, the page says so instead of guessing."],
    ["Do you also do coaching and partnership work?", "Yes — opportunity research, build coaching, and partnership work with universities and employers, national in scope. See Work With Us."],
  ];
    ...
    <main class="about-page">
      <section class="about-hero">
        ...
        <aside class="about-founder-card">
          <img src="/assets/nathan-baker.jpeg" alt="Nathan Baker, founder of Bot That Lyfe" />
          <div>
            <span class="kicker">Founder, Bot That Lyfe</span>
            <h2>Nathan Baker</h2>
            <p>Computer Science, University of Michigan. Software engineering and business analytics experience across Microsoft, Citi, Veterans United, and Atomic Object — now pointed at the university-to-career pipeline in agentic AI and tech, nationally.</p>
          </div>
        </aside>
      </section>
      ...
      <section class="spotlight-section">
        <div class="spotlight-image"><img src="/assets/landing/api-data-model.jpg" alt="A laptop showing a data model diagram" /></div>
        <div>
          <span class="kicker">${icon("apartment")} Tech and Business Analytics, Pointed at University Research</span>
          <h2>Whatever a lab is building, someone funded it and someone's hiring for it — I map that first.</h2>
          <p>Years before this, I was a software engineer and business analyst at Microsoft, Citi, Veterans United, and Atomic Object — mapping how data, money, and decisions actually move through a complex system before anyone touched it. I grew up in Michigan, and my family's from the Missouri Bootheel, where I spent every summer growing up. Once I pointed that same discipline at the university research economy, it fit immediately: whether you're a student, a professor, or an employer, the approach is the same — map the real chain from funding to research to people to jobs, and source every claim before we build anything.</p>
          <div class="button-row">
      ...
      <section class="detail-enroll-band">
        <div>
          ...
          <h2>Bring me a real question — I'll tell you straight whether it's a fit.</h2>
          <p>Opportunity research, build coaching, and university/employer partnerships, national in scope.</p>
        </div>
        <a class="primary-button" href="/work-with-us">Work With Us ${icon("arrow_forward")}</a>
      </section>
      ...
      <section class="detail-enroll-band">
        <div>
          ...
          <h2>Bring me a real question about a university, a lab, or a career path.</h2>
          <p>Students, universities, employers — wherever you are in the country, every path starts with a conversation.</p>
        </div>
        <a class="primary-button" href="/work-with-us">Work With Us ${icon("arrow_forward")}</a>
      </section>
    </main>
      ...
      <section class="section compact">
        <div class="book-layout">
          <form class="form-stack booking-card booking-form" data-workwithus-form>
            ...
            <div class="two-col">
              <label>Organization<input data-workwithus-field="organization" autocomplete="organization" placeholder="University, company, or student org" /></label>
              <label>What best describes you?
                <select data-workwithus-field="orgType">
                  <option value="">Select one</option>
                  <option value="Student">Student</option>
                  <option value="University Department / Lab">University Department / Lab</option>
            ...
            <label>What do you need?
              <select data-workwithus-field="need">
                ...
                <option value="Build Coaching">Build Coaching</option>
                <option value="University or Employer Partnership">University or Employer Partnership</option>
          ...
          <aside class="book-sidebar">
            ...
            <div class="book-sidebar-block">
              ...
              <p>Computer Science, University of Michigan. Software engineering and business-analytics experience across Microsoft, Citi, Veterans United, and Atomic Object — now applied to tracking the university-to-career pipeline in agentic AI and tech nationally.</p>
...
export function renderProgramDetail(data, program) {
    ...
    <main class="product-detail-page">
      ...
      <section class="section compact detail-sales-band" id="outcomes">
        ...
        <div class="outcome-grid">
          <article><img src="/assets/landing/api-data-model.jpg" alt="An internal dashboard built during a requested Bot That Lyfe training engagement" /><h3>Tools built for your organization</h3><p>Data models, API endpoints, agent workflows, and decisions shaped by your real business, not a hypothetical one.</p></article>
      ...
      <section class="program-instructor-section">
        ...
        <div>
          ...
          <div class="button-row">
            <a class="primary-button" href="/for-organizations#request">Request Training ${icon("arrow_forward")}</a>
            <a class="outline-button" href="/about">About Bot That Lyfe</a>
          </div>
        </div>
      </section>
      ...
      <section class="detail-enroll-band">
        <div>
          ...
          <p>Includes agent setup help, Git repo guidance, architecture coaching, dedicated Bot That Lyfe Discord access, and the 4-day on-site engagement itself. <a href="/for-organizations">See full pricing and request the engagement</a>.</p>
        </div>
        <a class="primary-button" href="/for-organizations#request">Request Training ${icon("arrow_forward")}</a>
      </section>
    </main>
  ...
  return pageShell({
    title: `${program.name} | Custom Business Training | Bot That Lyfe Lab`,
    active: "programs",
    body,
    ...
    structuredData: [
      {
        ...
        "provider": {
          "@type": "Organization",
          "name": "Bot That Lyfe",
          "sameAs": "https://botthatlyfe.com",
        },
        "offers": offering
          ? {
              "@type": "Offer",
              "url": `https://botthatlyfe.com${checkoutHref}`,
...
export function renderForOrganizations(data) {
      ...
      <section class="home-hero league-detail-hero">
        ...
        <div class="hero-copy">
          ...
          <div class="button-row">
            ...
            <a class="secondary-button" href="mailto:autonate.ai@gmail.com?subject=Bot That Lyfe%20training%20question">Talk With Bot That Lyfe</a>
          </div>
        </div>
        <aside class="hero-program-panel">
      ...
      <section class="section compact" id="request">
        <div class="section-head">
          <div>
            ...
            <p>Pick how many employees you're training below. Every seat includes the full 4-day, 4-hour/day custom engagement, 3 real internal tools built for your business, and dedicated Bot That Lyfe Discord access. Need a different number? Enter it directly in the form.</p>
          </div>
        </div>
      ...
      <section class="section compact" id="pay">
        ...
        <div class="checkout-grid sponsorship-checkout" data-sponsorship-form>
          <section class="checkout-form">
            ...
            <p class="fine-print" data-sponsorship-status>Prefer to pay by invoice, or have questions first? Write to <a href="mailto:autonate.ai@gmail.com?subject=Bot That Lyfe%20training%20invoice">autonate.ai@gmail.com</a>.</p>
          </section>
        ...
        <div class="sponsorship-success" data-sponsorship-success hidden>
          ...
          <p>Next: we work with you to pick the 3 tools, schedule your 4 days, and get your team added to the Bot That Lyfe Discord to prepare.</p>
        </div>
      </section>
    </main>
  `;
  ...
  return pageShell({
    title: "Custom AI Training for Local Businesses | Bot That Lyfe",
...
export function renderEvents() {
    ...
    <main class="league-page consulting-page events-page">
      <section class="home-hero league-detail-hero">
        ...
        <div class="hero-copy">
          ...
          <h1>Where Bot That Lyfe shows up.</h1>
  ...
  return pageShell({
    title: "Events | Bot That Lyfe Lab",
    active: "events",
    body,
    canonicalPath: "/events",
    ogImage: "/assets/og/events.jpg",
    description:
      "Where Bot That Lyfe is showing up: agent-systems and human-systems events the lab's daily radars track, with real dates, locations, and links.",
    ogTitle: "Where Bot That Lyfe shows up.",
    ogDescription:
...
export function renderConsulting(data) {
  ...
  const body = `
    <main class="league-page consulting-page">
      <section class="home-hero league-detail-hero">
        ...
        <div class="hero-content">
        <div class="hero-copy">
          <span class="kicker">${icon("hub")} Bot That Lyfe Consulting</span>
          <h1>We build the internal AI tools your business wishes existed.</h1>
          <p>Your team knows the business. Bot That Lyfe knows intelligent systems. Together, we turn a real daily workflow — in agriculture, automotive, construction, finance, government, graphic arts, healthcare, manufacturing, or tourism — into an internal tool your own people can run and maintain. See it happen for free every week at the <a href="/events">Industry Build Labs</a>, or bring us your workflow directly.</p>
          <div class="button-row">
      ...
      <section class="section compact" id="book">
        <div class="section-head">
          <div>
            ...
            <p>Discovery calls are 15 or 30 minutes and are for organizations exploring whether Bot That Lyfe Consulting is a fit. Follow-ups run 30, 45, 60, 90, or 120 minutes for engagements already underway. Calls run 8:00 AM-6:00 PM Central, Monday-Friday.</p>
          </div>
        </div>
        <div class="book-layout">
          <form class="form-stack booking-card booking-form" data-booking-form>
            ...
            <p class="fine-print" data-booking-status>Prefer email? Write to <a href="mailto:autonate.ai@gmail.com?subject=Bot That Lyfe%20Consulting%20inquiry">autonate.ai@gmail.com</a>.</p>
          </form>
          <aside class="book-sidebar">
            <div class="book-sidebar-block">
              <span class="kicker">${icon("checklist")} What happens next</span>
  ...
  return pageShell({
    title: "AI Consulting for Southeast Missouri Businesses | Bot That Lyfe",
    active: "consulting",
    body,
    canonicalPath: "/consulting",
    ogImage: "/assets/og/consulting.jpg",
    description:
      "Bot That Lyfe Consulting builds real internal AI tools for Southeast Missouri businesses, fixed-scope, priced for a business your size, not an enterprise contract.",
      ...
      <section class="home-hero tutorials-detail-hero">
        ...
        <aside class="hero-program-panel">
          ...
          <div class="hero-panel-body">
            ...
            <p>New to programming? Start with Nate and Kai's story and learn JavaScript from zero. Know some code already? Jump straight into whichever course matches what you're building next. These are the same fundamentals behind every internal tool Bot That Lyfe ships.</p>
            <div class="hero-facts">
...
export function renderCommunity() {
  const body = `
    <main class="community-page">
      <section class="home-hero community-detail-hero">
        ...
        <div class="hero-content">
        <div class="hero-copy">
          <span class="kicker">${icon("groups")} Bot That Lyfe Community</span>
  ...
  return pageShell({
    title: "Community & Discord Support | Bot That Lyfe Lab",
    active: "community",
    body,
    canonicalPath: "/community",
    ogImage: "/assets/og/community.jpg",
    description:
      "Join the Bot That Lyfe Discord community for help with the four free AI and coding courses, requested team training, and any system you're building on your own — all day, every day.",
    ogTitle: "The systems lab has a Discord.",
    ogDescription:
      "Get setup help, code review, agent workflow practice, and project help with the Bot That Lyfe community — open all day, every day.",
  });
}
...
export function renderArticleDetail(article) {
  ...
  return pageShell({
    title: `${article.title} | Bot That Lyfe`,
    active: "articles",
    body,
    ...
    structuredData: [
      {
        ...
        "description": article.summary,
        "image": `https://botthatlyfe.com${article.image}`,
        "datePublished": article.datePublished,
        "dateModified": article.dateModified || article.datePublished,
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": `https://botthatlyfe.com/articles/${article.handle}`,
        },
        "author": {
          "@type": "Person",
          "name": "Nathan Baker",
          "url": "https://botthatlyfe.com/about",
        },
        "publisher": {
          "@type": "Organization",
          "name": "Bot That Lyfe",
          "logo": {
            "@type": "ImageObject",
            "url": "https://botthatlyfe.com/assets/brand/logo-512.png",
          },
        },
      },
    ],
...
export function renderCheckout(data) {
  ...
  const body = `
    <main class="checkout-page">
      ...
      <div class="checkout-grid">
        <section class="checkout-form">
          ...
          <p class="checkout-lede">You are reserving one seat in ${escapeHtml(program?.name || "the Bot That Lyfe program")}. Card payment is processed securely through Square; learner onboarding details come next after payment is confirmed.</p>
          <div class="square-status" data-square-status hidden></div>
          <div class="checkout-product-strip">
            <div>
              <strong>${escapeHtml(program?.name || "Bot That Lyfe Program")}</strong>
    ...
    <footer class="minimal-footer">&copy; 2026 Bot That Lyfe. Software systems, built with AI agents.</footer>
    ${dataScript(data)}
  `;

  return pageShell({
    title: "Checkout | Bot That Lyfe",
    active: "checkout",
    body,
    mode: "checkout",
    ...
    description: `Reserve a seat in ${program?.name || "the Bot That Lyfe program"}.`,
...
export function renderSuccess(data) {
  ...
  return pageShell({
    title: "Enrollment Confirmed | Bot That Lyfe",
    active: "success",
    body,
    canonicalPath: "/success",
    robots: "noindex,nofollow",
    ogImage: `/assets/og/${primaryProgram?.handle || "ai-agent-systems"}.jpg`,
    description: `Enrollment confirmed for ${primaryProgram?.name || "the Bot That Lyfe program"}.`,
    ...
    <article class="program-feature ${extraClass}">
      ...
      <div class="program-feature-body">
        ...
        <div class="cohort-date-row compact">
          ${cohortBadge(program)}
          <span>${escapeHtml(program.cohortNote || "")} ${cohortCapacity(program)}. Dedicated Bot That Lyfe Discord included for setup help, architecture reviews, agent workflow coaching, and build support.</span>
        </div>

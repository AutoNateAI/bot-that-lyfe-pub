...
Nate and Kai run a two-person studio, Bot That Lyfe, and they've spent the last few chapters moving everything they know about it — the people they've met at the Fairview Founders Table meetup, their idea backlog, the feedback attached to both — out of phone notes and into a real database called `studio.db`. Three tables, clean foreign keys, SQL that answers in a fraction of a second. It has been working beautifully.
